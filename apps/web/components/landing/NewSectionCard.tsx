...
export function NewSectionCard({
  ...
  const computedDiscord = discordUrl || "#";
  return (
    <div className={`relative group ${className}`}>
      {/* Main card container with theme colors */}
      <div className="card relative bg-[#0A0A0A] rounded-xl overflow-hidden border border-[#121214] shadow-[0_0_10px_#0A0A0A] p-2.5">

        {/* Floating light animation - adapted to theme colors */}
        ...
        <div className="relative h-80 overflow-hidden flex items-center justify-center mt-4">
          <div className="image-container w-72 h-72">
            <Image
              className="usc-image object-cover w-full h-full rounded-lg"
              alt={alt}
              src={imageSrc}
              width={288}
              height={288}
        ...
        {/* Heading with flash animation */}
        <div className="relative -mt-8 px-2.5 py-2.5">
          <h3 className="heading text-center font-semibold text-sm text-[#E3E6EC]">
            {heading}
          </h3>
        </div>

        {/* Social icons */}
        <div className="icons flex gap-2.5 mt-4">
          <a
            className="flex flex-1 items-center justify-center bg-[#121214] text-[#E3E6EC] p-1.5 rounded-md hover:bg-[#1A1B1E] transition-colors duration-200"
            href={instagramUrl}
      ...
      <style jsx>{`
        /* Floating light animation - with theme colors */
        .floating-light {
          content: "";
          position: absolute;
          width: 120%;
          ...
          top: 40%;
          left: -10%;
          background: linear-gradient(144deg, var(--gold-300), var(--gold-500) 50%, var(--gold-700));
        ...
        .card:hover {
          ...
          box-shadow: 0 4px 20px rgba(255, 182, 72, 0.1);
