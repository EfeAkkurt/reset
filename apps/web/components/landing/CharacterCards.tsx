    ...
    <div className="card">
      ...
      <div className="bottom-section">
        ...
        <div className="icons">
          ...
          {discordUrl && (
            <a href={discordUrl} className="discord">
              <svg
                width="25"
                height="25"
                viewBox="0 0 25 25"
      ...
      <style jsx>{`
        ...
        .card:hover .heading::after {
          ...
          width: 9em;
          height: 9em;
          box-shadow: 0px 0px 250px rgba(193, 119, 241, 1),
          0px 0px 250px rgba(135, 42, 211, 1), inset #9b40fc 0px 0px 40px -12px;
        }
...
export function CharacterCards({ progress = 0 }: { progress?: number }) {
  const characters = [
    {
      name: "Efe",
      imageSrc: "/efe.png",
      instagramUrl: "https://www.instagram.com/efeakkurtofficial",
      ...
      <div className="mx-auto flex h-full max-w-6xl items-center px-6 pt-20">
        ...
        >
          <div className="text-center mb-12">
            <div className="typo-eyebrow mb-4">The Minds Behind Reset</div>
            <h2 className="typo-h2">
              Meet the architects building the future of DeFi
            </h2>
          </div>
