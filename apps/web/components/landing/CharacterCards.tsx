  ...
  return (
    <div className="card">
      ...
      <div className="icons">
        ...
        {discordUrl && (
          <a className="discord" href={discordUrl}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 25 25"
  ...
  const characters = [
    {
      ...
      discordUrl: "https://discord.com/channels/@me/404332976868950026",
    },
    {
      name: "Cengo",
      imageSrc: "/cengo.png",
      ...
      discordUrl: "https://discord.com/channels/@me/369554756076568577",
    },
  ];
