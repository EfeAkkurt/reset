...
export type ChainKey = "all" | "ethereum" | "solana";
...
const CHAINS: Array<{ id: ChainKey; label: string; disabled?: boolean }> = [
  { id: "all", label: "All Chains" },
  { id: "ethereum", label: "Ethereum", disabled: true },
  { id: "solana", label: "Solana", disabled: true },
];
          ...
          {CHAINS.map(({ id, label, disabled }) => {
            ...
            return (
              <button
                ...
                onClick={() => handleClick(id, disabled ?? false)}
              >
                {label}
              </button>
            );
