  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="font-display font-semibold tracking-[0.01em] text-center text-white text-[clamp(72px,12vw,280px)] leading-[0.9] select-none drop-shadow-[0_6px_24px_rgba(0,0,0,0.5)]"
      >
        Reset
      </motion.h1>
